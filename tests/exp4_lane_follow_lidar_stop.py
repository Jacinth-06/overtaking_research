...
<title>Exp 5 — Lane Follow + LiDAR Stop</title>
<style>
  :root {
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  #error-bar { position: absolute; height: 100%; width: 4px;
               ...
               transform: translateX(-50%); transition: left .1s; border-radius: 9px; }
...
<body>
<h1>&#9675; Exp 5 &mdash; Lane Follow + LiDAR Stop</h1>
<div class="grid">
  <div class="card">
    <h2>Camera feed</h2>
  ...
  <div class="card">
    ...
    <hr class="divider">
    <h2>ROI</h2>
    <div class="slider-row"><label>ROI Top Frac</label><input type="range" id="roi_top_frac" min="0.1" max="0.9" value="0.5" step="0.05"><span class="val" id="v-roi_top_frac">0.5</span></div>
...
async function poll() {
  try {
    ...
    if(btn) { if(isTesting) { btn.innerHTML = "&#9632; END TEST"; btn.style.background = "#ffb020"; } else { btn.innerHTML = "&#9654; START TEST"; btn.style.background = "#6b7a99"; } }
